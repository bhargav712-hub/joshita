    ...
    <>
      ...
      <nav id="nav" className={scrolled ? 'scrolled' : ''}>
        <div className="wrap nav-inner">
          ...
          <ul className={`nav-links${menuOpen ? ' openm' : ''}`} id="navLinks">
            ...
            <li><a href="#book" className="btn btn-primary nav-cta" onClick={closeMenu}>Book Now</a></li>
          </ul>
        ...
        <div className="wrap hero-grid">
          <div>
            ...
            <div className="hero-ctas">
              <a href="#book" className="btn btn-primary">Reserve Your Date</a>
      ...
      <section className="menu" id="menu">
        <div className="wrap">
          ...
          <h2 className="section-title">The ARIVA Culinary Journey</h2>
          <p className="section-sub">Hyderabad's favourites with a premium touch — every dish cooked live, every dish something your guests already love. Nothing frozen, nothing reheated, nothing pretentious.</p>
          <div className="acts">
            <div className="act open">
              <div className="act-head"><h3><span className="act-roman">01</span> Welcome</h3><span className="act-tag">Starters &amp; Coolers</span></div>
              <div className="act-body"><ul className="act-items">
                <li>Punugulu with allam chutney <em>fried live</em></li><li>Mirchi bajji <em>fried live</em></li><li>Paneer 65</li><li>Chicken 65</li><li>Fresh fruit coolers &amp; mocktail counter</li>
              </ul></div>
            </div>
            <div className="act">
              <div className="act-head"><h3><span className="act-roman">02</span> Small Plates</h3><span className="act-tag">Tandoor &amp; Grill</span></div>
              <div className="act-body"><ul className="act-items">
                <li>Tandoori chicken</li><li>Chicken malai tikka</li><li>Paneer tikka</li><li>Veg seekh kebab</li><li>Masala bhutta <em>charcoal grilled</em></li>
              </ul></div>
            </div>
            <div className="act">
              <div className="act-head"><h3><span className="act-roman">03</span> Live Station Experience</h3><span className="act-tag">Live Indo-Chinese</span></div>
              <div className="act-body"><ul className="act-items">
                <li>Hakka noodles — veg / chicken <em>tossed live</em></li><li>Schezwan fried rice</li><li>Chilli paneer</li><li>Veg manchurian</li><li>Steamed momos <em>live steamer</em></li>
              </ul></div>
            </div>
            <div className="act">
              <div className="act-head"><h3><span className="act-roman">04</span> Signature Mains</h3><span className="act-tag">Mains</span></div>
              <div className="act-body"><ul className="act-items">
                <li>Hyderabadi chicken dum biryani</li><li>Veg dum biryani</li><li>Butter chicken with butter naan</li><li>Paneer butter masala</li><li>Ghee karam dosa <em>live tawa</em></li><li><strong>Your Family Recipe</strong> — see Heritage Recipe Experience below</li>
              </ul></div>
            </div>
            <div className="act">
              <div className="act-head"><h3><span className="act-roman">05</span> Sweet Finale</h3><span className="act-tag">Live Desserts</span></div>
              <div className="act-body"><ul className="act-items">
                <li>Jalebi with rabri <em>piped &amp; fried live</em></li><li>Gulab jamun</li><li>Double ka meetha</li><li>Ice-cream rolls <em>rolled live</em></li><li>Kulfi &amp; cutting chai closer</li>
              </ul></div>
            </div>
          </div>
          <div className="menu-illus" aria-hidden="true">
            <figure><svg width="86" height="74" viewBox="0 0 100 86" fill="none"><path d="M14 56 q36 -18 72 0 l-6 14 q-30 12 -60 0 Z" fill="#B5532D" /><ellipse cx="50" cy="56" rx="36" ry="9" fill="#93421F" /><path d="M38 40 q-6 -8 0 -15" stroke="#D8A47F" strokeWidth="3" strokeLinecap="round" /><path d="M52 36 q-6 -9 0 -17" stroke="#D8A47F" strokeWidth="3" strokeLinecap="round" /><path d="M64 40 q-5 -8 0 -14" stroke="#D8A47F" strokeWidth="3" strokeLinecap="round" /></svg><figcaption>Dum Biryani</figcaption></figure>
            <figure><svg width="86" height="74" viewBox="0 0 100 86" fill="none"><circle cx="50" cy="52" r="26" fill="none" stroke="#B5532D" strokeWidth="7" /><circle cx="50" cy="52" r="13" fill="none" stroke="#B5532D" strokeWidth="6" /><circle cx="50" cy="52" r="4" fill="#B5532D" /><path d="M76 30 q6 -8 14 -6" stroke="#D8A47F" strokeWidth="3" strokeLinecap="round" /></svg><figcaption>Live Jalebi</figcaption></figure>
            <figure><svg width="92" height="74" viewBox="0 0 110 86" fill="none"><ellipse cx="55" cy="58" rx="44" ry="10" fill="#93421F" /><path d="M22 56 a33 18 0 0 1 66 0 Z" fill="#F4EFE6" /><path d="M30 52 a25 12 0 0 1 50 0" stroke="#D8A47F" strokeWidth="3" fill="none" /><path d="M46 30 q-5 -8 0 -15" stroke="#D8A47F" strokeWidth="3" strokeLinecap="round" /><path d="M62 28 q-5 -8 0 -14" stroke="#D8A47F" strokeWidth="3" strokeLinecap="round" /></svg><figcaption>Ghee Karam Dosa</figcaption></figure>
            <figure><svg width="86" height="74" viewBox="0 0 100 86" fill="none"><rect x="22" y="38" width="56" height="30" rx="6" fill="#B5532D" /><path d="M30 38 q20 -26 40 0 Z" fill="#F4EFE6" /><circle cx="42" cy="52" r="4" fill="#F4EFE6" /><circle cx="58" cy="52" r="4" fill="#F4EFE6" /><path d="M50 24 q-5 -8 0 -14" stroke="#D8A47F" strokeWidth="3" strokeLinecap="round" /></svg><figcaption>Tandoor Station</figcaption></figure>
          </div>
        ...
        <div className="wrap">
          ...
          <div className="tiers">
            <div className="tier reveal card3d">
              <h3>Intimate</h3><div className="tier-guests">Up to 20 guests</div>
              <div className="tier-price">₹19,999 <small>flat</small></div>
              <ul>
                <li>5 live-cooked courses</li>
                <li>1 live station + chef &amp; helper</li>
                <li>Fresh coolers &amp; mocktail counter</li>
                <li>Add a Heritage Recipe +₹2,500</li>
                <li>Full setup, service &amp; cleanup</li>
              </ul>
              <div className="tier-perfect"><h5>Perfect for</h5><p>High tea · Kitty parties · Family gatherings</p></div>
              <a href="#book" className="btn btn-outline" onClick={() => setPkg('Intimate')} style={{ marginTop: '24px' }}>Enquire</a>
            </div>
            <div className="tier featured reveal card3d">
              <span className="tier-badge">Most Loved</span>
              <h3>Curated</h3><div className="tier-guests">Up to 35 guests</div>
              <div className="tier-price">₹32,999 <small>flat</small></div>
              <ul>
                <li>7 live-cooked courses</li>
                <li>2 live stations + chef team</li>
                <li>1 Heritage Recipe included</li>
                <li>Live dessert counter</li>
                <li>Full setup, service &amp; cleanup</li>
              </ul>
              <div className="tier-perfect"><h5>Perfect for</h5><p>Birthdays · Anniversaries · House parties</p></div>
              <a href="#book" className="btn btn-primary" onClick={() => setPkg('Curated')} style={{ marginTop: '24px' }}>Enquire</a>
            </div>
            <div className="tier reveal card3d">
              <h3>Signature</h3><div className="tier-guests">Up to 50 guests</div>
              <div className="tier-price">₹44,999 <small>flat</small></div>
              <ul>
                <li>9 live-cooked courses</li>
                <li>3 live stations + chef brigade</li>
                <li>2 Heritage Recipes included</li>
                <li>Tandoor, wok &amp; live dessert counters</li>
                <li>Full setup, service &amp; cleanup</li>
              </ul>
              <div className="tier-perfect"><h5>Perfect for</h5><p>Milestone celebrations · Corporate gatherings · Luxury private events</p></div>
              <a href="#book" className="btn btn-outline" onClick={() => setPkg('Signature')} style={{ marginTop: '24px' }}>Enquire</a>
            </div>
          </div>
          <div className="bespoke-bar reveal">
            ...
            <a href="#book" className="btn btn-outline" onClick={() => setPkg('Bespoke')}>Start a Conversation</a>
          </div>
          <div className="addons reveal">
            <h4>Transparent add-ons</h4>
            <div className="addon-chips">
              <span>Extra hour · ₹2,500</span><span>Extra live station · ₹4,000</span><span>Heritage Recipe on Intimate · ₹2,500</span><span>Beyond 12 km · ₹50/km</span><span>Saturday peak · +10%</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="founding">
        <div className="wrap founding-inner">
          ...
          <a href="#book" className="btn" onClick={() => setPkg('Founding Twenty')}>Claim a Founding Spot</a>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="book-grid">
            <div className="book-info">
              ...
              <p>WhatsApp us directly — it's the fastest way to check a date.<br /><a href="https://wa.me/919703823111" target="_blank" rel="noopener noreferrer">Chat on WhatsApp →</a></p>
              <h3>Write to us</h3>
            ...
            <form className="form-card" id="bookForm" onSubmit={handleBooking}>
              <div className="form-row">
                <div className="field"><label htmlFor="fname">Your Name</label><input type="text" id="fname" placeholder="Full name" required /></div>
                <div className="field"><label htmlFor="fphone">Phone</label><input type="tel" id="fphone" placeholder="10-digit mobile" pattern="[0-9]{10}" required /></div>
              </div>
              <div className="form-row">
                <div className="field"><label htmlFor="fdate">Event Date</label><input type="date" id="fdate" ref={fdateRef} required /></div>
                <div className="field"><label htmlFor="fguests">Guest Count</label><input type="number" id="fguests" min="15" max="50" placeholder="e.g. 30" required /></div>
              </div>
              <div className="form-row">
                <div className="field"><label htmlFor="fpkg">Package</label>
                  <select id="fpkg" ref={fpkgRef}>
                    <option>Not sure yet — recommend one</option>
                    <option>Founding Twenty — ₹15,999</option>
                    <option>Intimate — ₹19,999</option>
                    <option>Curated — ₹32,999</option>
                    <option>Signature — ₹44,999</option>
                    <option>Bespoke — let's talk</option>
                  </select>
                </div>
                <div className="field"><label htmlFor="fpin">Pincode</label><input type="text" id="fpin" placeholder="Hyderabad pincode" maxLength="6" inputMode="numeric" onChange={handlePincode} />
                  <span className={`pincode-msg${pinMsg.cls ? ' ' + pinMsg.cls : ''}`}>{pinMsg.text}</span>
                </div>
              </div>
              <div className="field"><label htmlFor="fnotes">Tell us about your event</label><textarea id="fnotes" placeholder="Occasion, dietary preferences, allergies, a family recipe you'd love cooked live…"></textarea></div>
              <button type="submit" className="btn btn-primary" style={{ width: '100%' }}>Send Enquiry on WhatsApp</button>
      ...
      {/* FLOATING WHATSAPP */}
      <a className="wa-float" href="https://wa.me/919703823111?text=Hi%20ARIVA!%20I'd%20like%20to%20know%20more%20about%20booking%20a%20live-kitchen%20experience." target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
